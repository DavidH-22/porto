...
<nav class="sticky top-0 z-50 w-full bg-slate-50/80 backdrop-blur-md border-b border-slate-200">
    <div class="max-w-3xl mx-auto px-6 h-16 flex justify-between items-center">
        ...
        <a href="#top" class="flex items-center gap-2 font-bold text-sm tracking-tight text-slate-900 group">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="text-teal-600 group-hover:rotate-6 transition-transform">
                <polyline points="16 18 22 12 16 6"></polyline>
                <polyline points="8 6 2 12 8 18"></polyline>
            </svg>
            <span>David <span class="text-teal-600 font-medium">Hartono</span></span>
        </a>
